...
ActiveRecord::Schema.define(version: 2023_08_17_101049) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.index ["user_id", "content_id"], name: "index_bookmarks_on_user_id_and_content_id", unique: true
  ...
  create_table "content_quesition_tags", force: :cascade do |t|
